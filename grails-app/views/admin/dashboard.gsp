        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Joueurs</strong>
                        </div>
                        <div class="table-stats order-table ov-h">
                            <table class="table ">
                                ...
                                <tbody>
                                <g:each var="joueur" in="${joueurs}">
                                    <tr>
                                        <td>${joueur.idjoueur}.</td>
                                        <td>
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle" src="${joueur.photo}" alt=""></a>
                                            </div>
                                        </td>
                                        <td>  <span class="name">${joueur.login}</span> </td>
                                        <td>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Matchs</strong>
                        </div>
                        <div class="table-stats order-table ov-h">
                            <table class="table ">
                                <thead>
...
<asset:javascript src="admin/init/fullcalendar-init.js"/>
